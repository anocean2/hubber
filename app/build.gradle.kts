typealias and = com.hubber.internal.Android
typealias dep = com.hubber.internal.Dependencies
...
android {
    ...
    composeOptions {
        kotlinCompilerExtensionVersion = com.hubber.internal.Versions.compose
    }
    packagingOptions {
        resources {
